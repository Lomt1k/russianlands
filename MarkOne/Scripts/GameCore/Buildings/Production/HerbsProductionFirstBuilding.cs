...
public class HerbsProductionFirstBuilding : ProductionBuildingBase
{
    ...
    public override AvatarId firstWorkerIcon => AvatarId.Female_00;
    public override AvatarId secondWorkerIcon => AvatarId.Female_01;
