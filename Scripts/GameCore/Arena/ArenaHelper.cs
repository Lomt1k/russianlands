...
public static class ArenaHelper
{
    ...
    public static LeagueId GetActualLeagueForPlayer(Player player)
    {
        ...
        if (playerLevel <= 7)
        {
            return LeagueId.HALL_3;
        }
        if (playerLevel <= 10)
        {
            return LeagueId.HALL_4;
        }
        ...
        if (playerLevel <= 15)
        {
            ...
            {
                return LeagueId.HALL_5_START;
            }
            // HALL_5_MID: skills 6 - 15
            if (skillLevel <= 15)
            {
                return LeagueId.HALL_5_MID;
            }
            // skills 16 - 25
            return LeagueId.HALL_5_END;
        }
        if (playerLevel <= 20)
        {
            ...
            {
                return LeagueId.HALL_6_START;
            }
            // HALL_6_MID: skills 21 - 35
            if (skillLevel <= 35)
            {
                return LeagueId.HALL_6_MID;
            }
            // skills 36 - 50
            return LeagueId.HALL_6_END;
        }
        if (playerLevel <= 28)
        {
            ...
            {
                return LeagueId.HALL_7_START;
            }
            // HALL_7_MID: skills 46 - 55
            if (skillLevel <= 55)
            {
                return LeagueId.HALL_7_MID;
            }
            // skills 56 - 75
            return LeagueId.HALL_7_END;
        }
        if (playerLevel <= 35)
        {
            ...
            {
                return LeagueId.HALL_8_START;
            }
            // HALL_8_MID: skills 61 - 75
            if (skillLevel <= 75)
            {
                return LeagueId.HALL_8_MID;
            }
            // skills 76 - 100
            return LeagueId.HALL_8_END;
        }
        return LeagueId.HALL_8_END;
    }
}
