    ...
    public static class CharacterStickersHolder
    {
        ...
        private static void RefillStickersInfo()
        {
            _characterStickers = new Dictionary<CharacterType, StickerInfo>
            {
                ...
                { CharacterType.NifNif, new StickerInfo("russlandbot", 17) },
                { CharacterType.NafNaf, new StickerInfo("russlandbot", 18) },
                { CharacterType.NufNuf, new StickerInfo("russlandbot", 19) },
                { CharacterType.ChocolateKing, new StickerInfo("russlandbot", 20) },
                { CharacterType.OrcLeader, new StickerInfo("russlandbot", 21) },
                { CharacterType.OrcGuardian, new StickerInfo("russlandbot", 22) },
                { CharacterType.Troll, new StickerInfo("russlandbot", 23) },
                { CharacterType.GnomeCommander, new StickerInfo("russlandbot", 24) },
                { CharacterType.OrcTraitor, new StickerInfo("russlandbot", 25) },
                { CharacterType.ElvenKing, new StickerInfo("russlandbot", 26) },
                { CharacterType.Commissioner, new StickerInfo("russlandbot", 27) },
                { CharacterType.RobinBad, new StickerInfo("russlandbot", 28) },
                { CharacterType.Ent, new StickerInfo("russlandbot", 29) },
                { CharacterType.Anariel, new StickerInfo("russlandbot", 30) },
                { CharacterType.Tavrilia, new StickerInfo("russlandbot", 31) },
                { CharacterType.Lovelas, new StickerInfo("russlandbot", 32) },
                { CharacterType.Banker, new StickerInfo("russlandbot", 33) },
                { CharacterType.Eagle, new StickerInfo("russlandbot", 34) },
                { CharacterType.DemonOfWrath, new StickerInfo("russlandbot", 35) },
                { CharacterType.DemonOfGreed, new StickerInfo("russlandbot", 36) },
                { CharacterType.DemonOfLie, new StickerInfo("russlandbot", 37) },
            };
        }
