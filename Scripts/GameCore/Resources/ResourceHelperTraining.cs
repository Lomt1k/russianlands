...
{
    private static readonly Dictionary<int, int> boostTrainingInDiamondsBySeconds = new Dictionary<int, int>
    {
        { 60, 1 },
        { 18_000, 45 },
        { 86_400, 250 },
    ...
    private static readonly KeyValuePair<int, int> minBoostTrainingInDiamondsBySeconds;
    private static readonly KeyValuePair<int, int> maxBoostTrainingInDiamondsBySeconds;
    ...
    private static readonly Dictionary<int, int> defaultResourceTrainingTimeByCurrentLevel = new Dictionary<int, int>
    {
        { 1, 3600 },
        { 2, 7200 },
        { 3, 14_400 },
    ...
    private static readonly Dictionary<int, int> woodTrainingTimeByCurrentLevel = new Dictionary<int, int>
    {
        { 1, 7200 },
        { 2, 14_400 },
        { 3, 28_800 },
    ...
    private static readonly Dictionary<int, int> warriorTrainingTimeByCurrentLevel = new Dictionary<int, int>
    {
        // Ратуша 2
        { 1, 30 },
        { 2, 30 },
